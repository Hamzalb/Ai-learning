      ...
      <div className="space-y-5 max-w-3xl">
        ...
        <div className="grid grid-cols-2 gap-4">
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="glass-card p-5">
            ...
            <p className="text-3xl font-extrabold text-emerald-400 mt-1 tabular-nums">${total.toLocaleString()}</p>
          </motion.div>
              ...
              {loading ? <tr><td colSpan={5} className="text-center py-12 text-muted-foreground">Loading...</td></tr>
                ...
                : payslips.map((p, i) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-4 font-bold text-emerald-400 tabular-nums">${p.amount.toLocaleString()} {p.currency}</td>
